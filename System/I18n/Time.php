...
class Time extends DateTime
{
     ...
     */
    protected static Time|null|DateTimeInterface $testNow;
     ...
     *
     */
    public static function now(DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
     ...
     * @throws Exception
     */
    public static function parse(string $datetime, DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
     ...
     * @throws Exception
     */
    public static function today(DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
     ...
     *
     */
    public static function yesterday(DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
     ...
     *
     */
    public static function tomorrow(DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
        return new self(date('Y-m-d 00:00:00', strtotime('+1 day')), $timezone, $locale);
    }
     ...
     * @return Time
     */
    public static function createFromDate(?int $year = null, ?int $month = null, ?int $day = null, $timezone = null, ?string $locale = null): Time
    {
     ...
     * @return Time
     */
    public static function createFromTime(?int $hour = null, ?int $minutes = null, ?int $seconds = null, $timezone = null, ?string $locale = null): Time
    {
     ...
     *
     */
    public static function create(?int $year = null, ?int $month = null, ?int $day = null, ?int $hour = null, ?int $minutes = null, ?int $seconds = null, DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
        $year ??= date('Y');
        $month ??= date('m');
        $day ??= date('d');
    ...
    public static function createFromFormat(string $format, string $datetime, $timezone = null): Time
    {
     ...
     *
     */
    public static function createFromTimestamp(int $timestamp, DateTimeZone|string $timezone = null, ?string $locale = null): Time
    {
     ...
     * @return Time
     */
    public static function createFromInstance(DateTimeInterface $dateTime, ?string $locale = null): Time
    {
     ...
     * @codeCoverageIgnore
     */
    public static function instance(DateTime $dateTime, ?string $locale = null): Time
    {
     ...
     *
     */
    public function setMonth(int|string $value): Time
    {
     ...
     *
     */
    public function setHour(int|string $value): Time
    {
        if ($value < 0 || $value > 23) {
     ...
     *
     */
    protected function setValue(string $name, int $value): Time
    {
     ...
     */
    #[ReturnTypeWillChange]
    public function setTimestamp($timestamp): Time
    {
     ...
     * @throws Exception
     */
    public function toDateTimeString(): bool|string
    {
     ...
     * @return string
     */
    public function toDateString(): bool|string
    {
     ...
     * @return string
     */
    public function toFormattedDateString(): bool|string
    {
     ...
     * @return string
     */
    public function toTimeString(): bool|string
    {
     ...
     * @return bool|string
     */
    public function toLocalizedString(?string $format = null): bool|string
    {
     ...
     */
    public function difference(mixed $testTime, ?string $timezone = null): TimeDifference
    {
        $testTime = $this->getUTCObject($testTime, $timezone);
     ...
     */
    public function getUTCObject(mixed $time, ?string $timezone = null): DateTime|static
    {
